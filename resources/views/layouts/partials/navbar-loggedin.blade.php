...
<ul class="nav navbar-nav">
            ...
            <li class="{{ Request::segment(1) === 'posts/create' ? 'active' : null }}"><a href="{{ URL::to('posts/create') }}">Update Homepage</a></li>
            <li class="{{ Request::segment(1) === 'auth/logout' ? 'active' : null }}"><a href="{{ URL::to('auth/logout') }}">Logout</a></li>
        </ul>
